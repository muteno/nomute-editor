...
CLIP_MODEL_FB="${CLIP_MODEL_FB:-claude-opus-5}"; _mfb_tried=0; _eff=high   # Fable 실패/전용토큰 소진 → Opus max 1회 폴백(gen_image MODEL_FB 패턴 · 평의회 260722 P1 · 운영자 260726 전면 high)
