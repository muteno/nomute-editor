...
- **기업 실적 발표(분기·반기 매출·영업이익·영업손실·순이익 증감, 흑자·적자 전환, 배당) = 대기업이어도 기본 [1]** — 실적은 기업의 정기 공시·루틴이다(대기업이라는 이유로 [2] 금지). 단 ① 시장 전체 사건화가 제목에 드러나면(폭락·급락·서킷브레이커·상장폐지·대규모 구조조정 등) 원래 규정대로 [2~3] ② 중소·무명 기업의 실적 자화자찬 홍보는 여전히 [0].
