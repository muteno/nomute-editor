...
L, E = ['[통합 TOP 10]'], ['[통합 TOP 10 — 항목마다 채널(업로더)·링크, 큰 영상엔 시청자 인기 댓글 동봉]']
...
body = '\n'.join(L + tail)
PVER = 'brief-v9-260714-longstay'   # 캐시 1회 무효화 = v9: 장기 투숙 이슈 감쇠(이슈 원장 1·2·3회 규칙 — 운영자 260714) + 딥다이브 소스 강화(채널·URL·인기 댓글) · v8 호칭 제거·v7 참고자료 카드 유지
