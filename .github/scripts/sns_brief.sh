...
body = '\n'.join(L + tail)
PVER = 'brief-v10-260714-newcomer'   # 캐시 1회 무효화 = v10: [신규 진입] 신상 딱지(first_seen 6h · 감쇠로 비운 자리 = 신상 우선 — 운영자 260714 "신상 딱지 ㄱ") · v9 이슈 원장 감쇠+채널·URL·댓글, v8 호칭 제거, v7 참고자료 카드 유지
