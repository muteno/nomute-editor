...
🌡 **기상 관측·기록 게이트 (운영자 260803 — «대구 서구 40.1도» 신기록 오발 차단):**
폭염·한파·열대야·최고/최저기온·적설/강수량 등 **기상 현상·관측 수치 자체**를 전하는 제목은
아무리 기록적·이례적이어도(«사상 첫»·«역대급»·«40도 돌파»·신기록 경신·특보 발효/확대·[속보] 표기 포함)
날씨 보도이지 급발 사건이 아니다 → **X**.
⚠️ 단 그 기상으로 인한 **실제 피해·긴급 대응이 제목에 명시**되면 이 게이트 미적용 — 위 일반 규칙으로 판정
(사망·다수 온열질환/한랭질환 이송·대규모 대피·단수·정전·산불·붕괴·고립 등 2차 사건).
  예) "[속보] 대구 서구 40.1도…오후 1시 기준" → X · "폭염중대경보 확대…오전부터 불볕더위" → X · "서울 첫 열대야" → X
  예) "40도 폭염에 물도 바닥…청도군 일부 단수" → 단수 발생 = 판정 · "폭염에 온열질환자 30명 이송" → 다수 피해 = 판정
...
- 기온·기상 신기록/관측 수치·특보 발효/확대 — 실제 피해(사망·이송·대피·단수·정전·산불) 명시 없는 것 (🌡 게이트)
