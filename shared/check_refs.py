...
_DESIGN_BASELINE = {
    ...
    'viewer/thumb.html': {'accent_raw': 0, 'blur': 34, 'hex': 27},   # accent rgba 토큰화 완료(--accent-rgb·260621). blur/hex는 thumb 독자팔레트라 잔존(후속). blur32→34 = 저작권 복사칩(.cref-kw 글래스 blur 계승·260622) · hex…→28 = .go.err 미입력 빨강(#ff7a7a·#ff5d5d) · hex28→27 = 축약 체크 .dl-cbox 픽토그램 계승(흰 체크 #fff 제거·그라데는 --accent-bright :root 토큰·260622).
}
