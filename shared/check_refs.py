...
_DESIGN_BASELINE = {
    ...
    'viewer/thumb.html': {'accent_raw': 0, 'blur': 34, 'hex': 26},   # accent rgba 토큰화 완료(--accent-rgb·260621). blur/hex는 thumb 독자팔레트라 잔존(후속). hex 25→24 = .go solid #d8ff3d 제거(.mkbtn 고스트 통일·260621). blur32→34·hex24→26 = 축약 픽토그램(흰 체크 #fff)+저작권 복사칩(.cref-kw 글래스 blur 계승·260622).
}
