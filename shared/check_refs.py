...
# 재베이스라인 260718 00:08(사유): Q91 ×2 — 타 세션 행('요구사항 형식 직접주입' 작업표준)과 본 세션 프로토콜 블록(Q91~Q102) 리더가
#   각자 병렬 브랜치서 Q91 부여·커밋 박제분으로 병존 = 리넘버 불가(둘 다 커밋 완료 · 프로토콜 블록은 Q91~Q102 연속체라 리더만 재부여 시 참조 붕괴 · 타 세션 행 무접촉). 면책 승계(count 2 허용) · 본 세션 신규 행 = Q104 유일 · 다음 부여 = Q105.
_QDUP_BASE = {1: 41, 2: 19, 3: 17, 4: 16, 5: 14, 6: 13, 7: 12, 8: 9, 9: 8, 10: 6, 11: 5, 12: 5, 13: 5, 14: 3, 15: 2, 16: 3, 17: 2, 18: 2, 19: 2, 23: 2, 39: 2, 43: 2, 49: 2, 63: 2, 64: 2, 91: 2}   # 43·49·63·64 :2 = 260717 병렬 머지 병존(각 번호를 두 세션이 각자 부여·둘 다 main 실재 = 갈래 유산 · 재부여 불가[양쪽 머지 완료]라 면책 기록 · 43=스크림#2422+편집알림 / 49=평의회분신술+PAT후속 / 63·64=동시 세션 원장 경합) · 91:2 = 260718 병렬 브랜치 Q91 병존(작업표준 주입행 + 프로토콜 Q91~Q102 블록 리더 · 리넘버 불가 면책)
