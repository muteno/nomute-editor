...
_DESIGN_BASELINE = {
    ...
    'viewer/song.html': {'accent_raw': 0, 'blur': 8, 'hex': 4, 'accent_hex': 0, 'green_wash': 0, 'legacy_green': 0},   # 음원 탭 신설 편입(관례 · 260712). blur8 = .cpy(conv .urlclip 계승) 2 + .histbtn 2 + .hpop(msgpop 계승) 2 + 선택자 팝업 .selpop blur16(thumb .platpop 정본 계승 — 도형 나열 폐지 개편) 2. hex4 = #0e0f11·#2a2c31 각 2(textarea 룰 + .selin input 재선언 — 동일값·conv 관행 내).
