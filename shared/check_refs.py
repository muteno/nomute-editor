...
_DESIGN_BASELINE = {
    ...
    'viewer/song.html': {'accent_raw': 0, 'blur': 2, 'hex': 2, 'accent_hex': 0, 'green_wash': 0, 'legacy_green': 0},   # 음원 탭 신설 편입(신규 뷰어 게이트 사각 봉합 관례 · 260712). blur2 = .cpy 복사버튼 글래스 webkit+표준(conv .urlclip 계승). hex2 = 입력류 bg #0e0f11 + 결과 .rbox #0e0f11(conv 관행 내).
