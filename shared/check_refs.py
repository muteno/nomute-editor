...
_DESIGN_BASELINE = {
    'viewer/index.html': {'accent_raw': 124, 'blur': 94, 'hex': 168},   # accent_raw 105→123 요약본 스포티파이→노뮤트 / mkbtn 글래스 +1·blur90 / blur90→92 = 요약본 제목복사 버튼 글래스(운영자 260621) / 92→94 = 요약 헤더 .dlbox 글래스 알약 통합(backdrop+webkit·var(--blur-m) 토큰·260621)
