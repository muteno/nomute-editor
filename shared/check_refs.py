...
_QDUP_BASE = {1: 43, 2: 21, 3: 19, 4: 19, 5: 16, 6: 16, 7: 15, 8: 11, 9: 10, 10: 8,   # 1~10 각+1 = 재베이스라인 260802 22:2x(미리보기 통일 세션 image-studio-preview-sizing-qewbep — 훅 기계 캡처가 이 세션 Q01~Q10을 자동 등재했는데 같은 낮은 번호대가 origin/main에 이미 다수 박제 = --fix-qnum 「재부여 불가(양쪽 머지)」 판정 → 관례(1107·1072 선례)대로 면책 승계 · 박제 행 무접촉)
