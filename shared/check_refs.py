...
_DESIGN_BASELINE = {
    ...
    'viewer/song.html': {'accent_raw': 0, 'blur': 6, 'hex': 2, 'accent_hex': 0, 'green_wash': 0, 'legacy_green': 0},   # 음원 탭 신설 편입(관례 · 260712). blur6 = .cpy 복사버튼(conv .urlclip 계승) 2 + 만든 노래 .histbtn 글래스 2 + .hpop 팝업 blur26 saturate(msgpop §디자인 f 정본 계승) 2 — 전부 webkit+표준 쌍. hex2 = 입력류 bg #0e0f11 + 결과 .rbox #0e0f11(conv 관행 내).
