...
node shared/smoke_chan.js > "$L12" 2>&1; R12=$?   # 대분류 헤더 세그 배치·우변 계약·채널 잉크선·협폭 열(코어 10종 · 포트대 8846~ · 260721 Q337·Q345~351 승격 — 직렬 꼬리 = 상한 5 보존)
