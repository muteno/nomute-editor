...
#   geni(13종)+preview(10종·코어)+winnav(코어 10종 · 260717 Q02)+dlclip(교차 twin 코어 3종 · 260717 Q06) 병렬 실행 — 포트대 분리 설계(8791~/8796~/8801~/8806~)라 무충돌 ·
...
echo "── smoke_all FAIL (geni=$R1 · preview=$R2 · winnav=$R3 · dlclip=$R4)"; exit 1
