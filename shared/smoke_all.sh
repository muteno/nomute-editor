...
node shared/smoke_chan.js > "$L12" 2>&1; R12=$?   # 대분류 헤더 세그 배치·우변 계약(코어 7종 · 포트대 8846~ · 260721 Q337 한 수 승격 — 직렬 꼬리 = 상한 5 보존)
