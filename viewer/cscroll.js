// cscroll.js — 커스텀 오버레이 스크롤바(초록 글래스). 모바일 포함 전 플랫폼 동일 동작.
...
(function () {
  ...
  st.textContent =
    ...
    'background:rgba(15,253,2,.4);box-shadow:0 0 6px rgba(15,253,2,.32);' +
    'transition:background .25s,box-shadow .25s,width .15s;will-change:transform;}' +
    '.cscroll.act i{background:rgba(15,253,2,.72);box-shadow:0 0 9px rgba(15,253,2,.6);width:7px;}' +
